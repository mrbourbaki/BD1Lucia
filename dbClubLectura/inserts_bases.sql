...
INSERT INTO libro (titulo_original,sinopsis,nro_pags,ano,titulo_espanol,tema,fk_editorial,fk_clase,fk_libro_comp) VALUES
	...
	('ISLAND','EN LA UTÓPICA ISLA DE PALI, EN UN IMAGINARIO PACÍFICO, EL PERIODISTA WILL FARNABY DESCUBRE UNA NUEVA RELIGIÓN, UNA NUEVA ECONOMÍA AGRÍCOLA, UNA SORPRENDENTE BIOLOGÍA EXPERIMENTAL Y UN EXTRAORDINARIO AMOR A LA VIDA',200,1962,'LA ISLA',NULL,6,5,NULL);
...
INSERT INTO obra_actuada (resumen,precio,titulo,estatus_actividad,duracion,fk_sala) VALUES
	...
	('LA CULTURA OCCIDENTAL HA SUFRIDO MUCHOS CAMBIOS DESDE EL RENACIMIENTO INFLUENCIADOS POR EL DINERO Y LA RAZON', 10, 'HOMBRES Y ENGRANAJES', '1',120,5),
    ...
    ('LA INDUSTRIALIZACIÓN Y LA DIGITALIZACIÓN ESTÁN TENIENDO CONSECUENCIAS NO SOLO DE DESIGUALDAD ECONÓMICA ENTRE LOS PAÍSES, SINO TAMBIÉN SOCIAL E INCLUSO MEDIOAMBIENTAL',12,'LA ISLA','0',120,8);
...
INSERT INTO hist_lector (fecha_ini,doc_lector,id_club,estatus,motivo_retiro,fecha_fin) VALUES
	...
	('10-11-2016',334061189,1,'RETIRADO','VOLUNTARIO',NULL);
...
INSERT INTO reunion (id_grupo,id_club_grupo,id_grupo_hist_grupo,id_club_hist_grupo,fecha_hlector,doc_lector,id_club_hist_lector,id_libro,fecha_conclusiones,valoracion) VALUES
    ()
